...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240618151943_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.EmergencyDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.InsuranceDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Core.Entities.EmergencyDetails", "EmergencyDetails")
                        .WithOne("ApplicationUser")
                        .HasForeignKey("Core.Entities.ApplicationUser", "EmergencyDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.InsuranceDetails", "InsuranceDetails")
                        .WithOne("ApplicationUser")
                        .HasForeignKey("Core.Entities.ApplicationUser", "InsuranceDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
