    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmergencyDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_EmergencyDetails_EmergencyDetailsId",
                        column: x => x.EmergencyDetailsId,
                        principalTable: "EmergencyDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_InsuranceDetails_InsuranceDetailsId",
                        column: x => x.InsuranceDetailsId,
                        principalTable: "InsuranceDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Booking_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_EmergencyDetailsId",
                table: "AspNetUsers",
                column: "EmergencyDetailsId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_InsuranceDetailsId",
                table: "AspNetUsers",
